...
function checkAnswer(currentLevel){
    ...
    var startR = randomChosenColour.length - 1;
    var startU = userClickedPattern.length - 1;
    var a = randomChosenColour.indexOf(currentLevel);
    var b = userClickedPattern.indexOf(currentLevel);
